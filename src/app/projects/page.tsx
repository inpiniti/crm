    ...
    <>
      ...
      {projects.length === 0 ? (
        ...
        <Panel className="divide-y divide-border">
          <div className="grid grid-cols-[1fr_90px_90px_90px_110px] px-4 text-[12px] text-text-3">
          ...
          {projects.map((p) => (
            <Link key={p.id} href={`/projects/${p.id}`} className="row-hover grid grid-cols-[1fr_90px_90px_90px_110px] items-center px-4 py-2.5 text-[13.5px]">
